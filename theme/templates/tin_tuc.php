...
//$category = get_term_children(7, 'category');
...
?>
    <main>
        <section class="page-banner-nl">
            <div class="img ratio">
                <img class="w-100 d-block" src="<?= get_field('ban', get_category_by_slug($term)) ?>" alt="">
            </div>
            <div class="content">
                <div class="container">
                    ...
                    <ul>
                        <?php foreach ($category as $cate): ?>
                            ...
                            <?php if ($cate->slug == 'tin_tuc' || $cate->slug == 'new-en' || $cate->term_id == '34' ): ?>
                                <li><a class="<?= ($cate->slug == $term->slug) ? 'active' : '' ?>" href="<?= $link ?>"><?php pll_e('Tất cả'); ?></a></li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                        <?php foreach ($category as $cate): ?>
                            <?php $link =  get_category_link($cate->term_id) ?>
                            ...
                            <?php foreach ($post as $key => $value): ?>
                                <div class="col-md-4">
                                    <div class="items-news">
										...
										<span class="overflow-news"><img src="<?= checkImage($value->ID) ?>"></span>
                                        </a>
