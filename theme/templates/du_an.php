...
<main>
    ...
    <section class="page-linhvuc page-duan">
        <div class="container">
                ...
                <div class="form" action="">
                    ...
                    <div class="form-group">
                        <select class="form-control icon-ff progress" name="progress" id="progress">
                            ...
                            <option value="Cha hoàn thành"><?php pll_e('Chưa hoàn thành'); ?></option>
                        </select>
                    </div>
                    <div class="form-group">
            ...
            <div class="load_news">
                <a class="load-post" data-key="0" data-value="<?php echo posts_per_page_duan ?>"><?php pll_e('Xem thêm'); ?></a>
            </div>
        </div>
    </section>
</main>
...
<script>
    $(document).ready(function () {
        ...
        $('.box-submit').on('click', function () {
            var numberPage = $(this).data('value'); // bin lấy giá trị ( posts_per_page )
            var dataKey = $(this).data('key');
            var location = $('.location').val();
            var keyWord = $('.keyWord').val();
            var year = $('.year').val();
        ...
        searchData(); // khong có biến chuyn vo gọi hm searchData() n ra tt cả cc bi viết
        ...
        function searchData(keyWord, year, progress, dataKey, location, numberPage) {
            ...
            $.ajax({
                ...
                dataType: 'json', //d liu tr về dang json
                beforeSend: function () {
                ...
                success: function (data) {
                    ...
                    //in dữ liệu ra thẻ div (class = content-post)
                    ...
                    if (data.check == 'hide') { // kim tra giá trị check nếu là hide n class 'load-post'
                        $('.load_news').hide();
                    }
                }
            });
